...
面向乡镇（街道）综治中心的一体化社会治理智能平台，践行新时代"枫桥经验"，以国产大模型与智能体技术赋能基层矛盾纠纷全周期管理。系统支持**云+端双模 AI 架构**——云端调用 DeepSeek-v4-pro 享受顶级推理能力，本地部署 DeepSeek-R1 蒸馏模型确保敏感数据不出域，环境变量一键热切换。覆盖数据汇聚、智能去重、风险预警、处置跟进、分析报告、重点人员管理六大业务闭环。
